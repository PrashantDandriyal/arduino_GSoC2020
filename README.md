...
Keywords: _Arduino NANO, Accelerometer(LSM9DS1), gyroscope(LSM9DS1), BLE, TensorFlow, Library{ArduinoLSM9DS1, Arduino_TensorFlowLite}_
...
Keywords: _Arduino NANO, Microphone(MP34DT05), TensorFlow, Library{ PDM, ArduinoSound, Arduino_TensorFlowLite}_
...
Keywords: _Arduino NANO, Accelerometer(LSM9DS1), thermometer(HTS221), gyroscope(LSM9DS1), TensorFlow, Library { ArduinoLSM9DS1, ArduinoHTS221, Arduino_TensorFlowLite}_
...
Keywords: _Board-Independent, TensorFlow, Library: Arduino_TensorFlowLite_
...
I completed the _Introduction to TensorFlow_ course on Udacity and Andrew Ng's course on Coursera and participated in two of the ML competition on HackerEarth. I have been studying Machine Learning for about an year now. Mostly, I have used TensorFlow-Keras as the primary API. Regarding the languages, I have good experience of C, C++ and Python, all of which are he primary languages needed for this project. I have used C++ for several coding competitions held by Google.
